        ...
        <CardContent>
          <div>
            <div className={classes.sampleCode}>
              ...
              <code>
                [ &#123; "text": "Dog", "suffix_key": "a", "background_color":
                "#FF0000", "text_color": "#ffffff" &#125;,
              </code>
              <br></br>
              <code>
                &#123; "text": "Cat", "suffix_key": "c", "background_color":
                "#FF0000", "text_color": "#ffffff" &#125; ]
              </code>
            </div>
            <FormControl component="fieldset" className={classes.margin}>
              <FormLabel htmlFor="input-with-icon-adornment" component="legend">
                Select a file
              </FormLabel>
              <Input
